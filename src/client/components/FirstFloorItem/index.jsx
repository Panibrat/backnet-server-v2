...
const mapStateToProps = (store) => {
    return {
        ...
        isOnFirstFloorHF_WC_Left: (findPoint('AI3000183', store.ai).value > 5),
        isOnFirstFloorHF_kitchen_Left: (findPoint('AI3000185', store.ai).value > 5),
        isOnFirstFloorHF_zal_Left: (findPoint('AI3001180', store.ai).value > 5),
        isOnFirstFloorHF_hall_Left: (findPoint('AI3000186', store.ai).value > 5),
