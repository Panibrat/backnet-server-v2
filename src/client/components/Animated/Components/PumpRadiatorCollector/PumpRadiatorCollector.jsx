...
import styles from './PumpRadiatorCollector.css';

export const PumpRadiatorCollector = (props) => (
    <g transform="translate(0 -217.625)">
        <g transform="matrix(1.27182 0 0 -1.27182 117.648 860.803)">
            <path
                fill="#34cdfa"
                fillOpacity="null"
                stroke="#000"
            ...
            <g transform="translate(151.83 311.753) scale(.05096)">
                ...
                <circle cx="256" cy="256" r="64" fill="url(#k)" />
            </g>
        </g>
    </g>
);
