...
const mapStateToProps = (store) => {
    return {
        ...
        isOnFirstFloorHF_WC_Left: (findPoint('AI3001178', store.ai).value > 5) && findPoint('BI3001240', store.bi),
        isOnFirstFloorHF_kitchen_Left: (findPoint('AI3001176', store.ai).value > 5) && findPoint('BI3001240', store.bi),
        isOnFirstFloorHF_zal_Left: (findPoint('AI3001180', store.ai).value > 5) && findPoint('BI3001240', store.bi),
        isOnFirstFloorHF_hall_Left: (findPoint('AI3001177', store.ai).value > 5) && findPoint('BI3001240', store.bi),
